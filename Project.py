...
from mpl_toolkits.mplot3d import Axes3D  # เพื่อให้ 3D plot ใช้งานได้
...
# แก้ชื่อไฟล์ตรงนี้ได้ถ้าใช้ชื่ออื่น
...
# ============================================================
# 2. Basic correlation heatmap (numeric + dummies)
# ============================================================
...
# 3.2 3D scatter: distance vs angular vs font_size (color = visibility_score)
...
# 3.3 3D + size + color: distance, font_size, visibility (size = angular_size, color = can_read)
fig = plt.figure(figsize=(9, 7))
ax = fig.add_subplot(111, projection="3d")
...
# ============================================================
# 7. Calibration plot (ใช้ Random Forest เป็นตัวหลัก)
# ============================================================
